...
5. 강조: 중요한 단어는 **굵게** (예: **사회성**, **산책 매너**) 표시해 주세요.
...
{{
    ...
    "message": "오늘 산책에서 특히 주의할 점이나 기대되는 점, 강명 문장마다 적절히 **강조**를 사용하여 다정하고 세심한 어드바이스 (최소 3문장 이상, \\n 및 이모지 적극 활용)",
...
9. 다채로운 이모지(💖, 🐾, ✨, 🌟 등)를 적극 활용해주세요.
10. score는 십성 관계의 궁합 점수를 0~100으로 표현하세요.
